---
title: "Natural Language Processing Example"
author: "David Leydet"
date: "2024-09-30"
output: 
  html_document:
...
This is example code from Simon's AI workshop which explores NLP and its reseaerch uses. See [Simon's GitHub page](https://simonbrewer.github.io/ESS_AI_Workshop/ESS_03_NLP.html#Data) for more information.
...
This example uses climate change tweets from 2015-2018 located [here](https://www.kaggle.com/datasets/edqian/twitter-climate-change-sentiment-dataset?select=twitter_sentiment_data.csv).
...
[Google Drive Folder](https://drive.google.com/drive/folders/1GMEY1fYEj1YMI__u3hU4y6agnrz3ekna?usp=drive_link)

A good selection of alternative, pre-trained embeddings can be found at Hugging Face:

[Hugging Face](https://huggingface.co/models?other=text-embedding)
...
Carry out dimensionality reduction of a dataset using the Uniform Manifold Approximation and Projection (UMAP) method (McInnes et al., 2018). Some of the following help text is lifted verbatim from the Python reference implementation at [https://github.com/lmcinnes/umap](https://github.com/lmcinnes/umap).
